...
public class RenderPage {
    ...
    public void renderStart(Graphics g, int pBase) {
        ...
        g.fillRect(game.r.rx(Game.WIDTH / 2 - 280), game.r.ry((Game.HEIGHT / 2) - 300 + pBase), game.r.rx(330), game.r.ry(60 ));
        g.setColor(Color.white);
        g.setFont(new Font(Font.DIALOG, Font.BOLD, 50));
        g.drawString("TRAFFIC RACER", game.r.rx(Game.WIDTH / 2 - 275), game.r.ry(Game.HEIGHT / 2 - 250 + pBase));

        g.setColor(Color.black);
        g.fillRect(game.r.rx(Game.WIDTH / 2 - 75), game.r.ry(Game.HEIGHT / 2 - 150 + pBase), game.r.rx(150), game.r.ry(60 ));
        g.setColor(Color.white);
        g.setFont(new Font(Font.DIALOG, Font.BOLD, 50));
        g.drawString("START", game.r.rx(Game.WIDTH / 2 - 70), game.r.ry(Game.HEIGHT / 2 - 105 + pBase));
